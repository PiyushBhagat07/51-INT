                                    ...
                                    ?>
                                        <form action="web_script.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <img src="Uploads/Gallery Images/<?php echo $data['image_1']; ?>" style="height: 120px;width:120px;">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <img src="Uploads/Gallery Images/<?php echo $data['image_2']; ?>" style="height: 120px;width:120px;">
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <img src="Uploads/Gallery Images/<?php echo $data['image_3']; ?>" style="height: 120px;width:120px;">
                                                </div>
