                        ...
                        ?>
                            <div class=" col-md-8 col-lg-6 col-xl-4">
                                <div class="card text-black">
                                    <img src="Uploads/Property Images/<?php echo $data1['image']; ?>" class="card-img-top" alt="Image" style="height:200px;width:100%;" />
                                    <div class="card-body">
                                        <div class="text-center">
                                        ...
                                        <div class="d-flex justify-content-between mt-4">
                                            <a class="btn btn-warning" href="edit_property.php?property=<?php echo $data1['id']; ?>"> EDIT <i class="fa-solid fa-edit"></i></a>
