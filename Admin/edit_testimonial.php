...
<head>
    ...
    <title>Admin Panel | Manage Testimonials </title>
    <!-- General CSS Files -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <?php
                                    $q = "SELECT * FROM testimonials WHERE id='$testimonial'";
                                    ...
                                    ?>
                                        <form action="web_script.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Message</label>
                                                    <textarea name="message" id="description" maxlength="200" class="form-control" required><?php echo $data['message']; ?></textarea>
                                                    <span id="current_desc" style="color: #59bf70;">0</span>
                                                    <span id="" style="color: #59bf70;">/ 200</span>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <img src="Uploads/Testimonial Images/<?php echo $data['image']; ?>" style="height: 120px;width:120px;">
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <input type="hidden" name="id" value="<?php echo $testimonial; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="container">
                                                <div class="text-center">
                                                    <div class="form-group">
                                                        <button type="submit" name="update_testimonial" class="btn btn-primary btn-lg">Update </button>
                                                        <a href="testimonials.php" class="btn btn-danger btn-lg" style="margin-left:20px;">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
