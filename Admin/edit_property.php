                                        ...
                                        <fieldset>
                                            <div class="form-group form-float">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <img src="Uploads/Property Images/<?php echo $data['image']; ?>" style="height: 120px;width:120px;">
                                                    </div>
                                        ...
                                        <fieldset>
                                            <div class="form-group form-float">
                                                <div class="row">
                                                    ...
                                                    ?>
                                                        <div class="form-group col-md-6">
                                                            <img src="Uploads/Videos/<?php echo $data1['image']; ?>" style="height: 120px;width:120px;">
                                                        </div>
